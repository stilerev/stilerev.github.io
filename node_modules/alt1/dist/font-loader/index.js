(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory((function webpackLoadOptionalExternalModule() { try { return require("canvas"); } catch(e) {} }()), (function webpackLoadOptionalExternalModule() { try { return require("electron/common"); } catch(e) {} }()), require("sharp"));
	else if(typeof define === 'function' && define.amd)
		define(["canvas", "electron/common", "sharp"], factory);
	else {
		var a = typeof exports === 'object' ? factory((function webpackLoadOptionalExternalModule() { try { return require("canvas"); } catch(e) {} }()), (function webpackLoadOptionalExternalModule() { try { return require("electron/common"); } catch(e) {} }()), require("sharp")) : factory(root["canvas"], root["electron/common"], root["sharp"]);
...
const OCR = __importStar(__webpack_require__(/*! alt1/ocr */ "./src/ocr/index.ts"));
const a1lib = __importStar(__webpack_require__(/*! alt1/base */ "./src/base/index.ts"));
a1lib.NodePolyfill.polyfillRequire((mod) => {
    if (mod == "sharp") {
...
function default_1(source) {
    ...
    (async () => {
        ...
        var imgfile = (0, sharp_1.default)(bytes);
        var imgdata = await imgfile.ensureAlpha().raw().toBuffer({ resolveWithObject: true });
        if (imgdata.info.premultiplied) {
            console.warn("png unpacking used premultiplied alpha, pixels with low alpha values have suffered loss of precision in rgb channels");
        }
...
const base_1 = __webpack_require__(/*! alt1/base */ "./src/base/index.ts");
exports.debug = {
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/font-loader/index.ts");
/******/ 	
